package com.limh.qrcode.activity;
...
import com.limh.qrcode.R;
import com.limh.qrcode.camera.CameraManager;
import com.limh.qrcode.decoding.CaptureActivityHandler;
import com.limh.qrcode.decoding.InactivityTimer;
import com.limh.qrcode.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.zxing_img_close).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (null != getAnalyzeCallback()) {
                    getAnalyzeCallback().onCancel();
                }
            }
        });
        return view;
    ...
    public void onResume() {
        ...
        if (null == audioService) {
            playBeep = false;
        } else if (audioService.getRingerMode() == AudioManager.RINGER_MODE_NORMAL) {
            playBeep = false;
        }
        initBeepSound();
        vibrate = true;
